...
public class BRule extends Rule {
	private static final long serialVersionUID = -883143779593751301L;

	public BRule() {
		super(ChessmanType.±ø);
	}

	private Integer inblackX;

	private Integer inblackY;

	private Integer inredX;

	private Integer inredY;
	...
	public Integer getInblackX() {
		return inblackX;
	}

	public void setInblackX(Integer inblackX) {
		this.inblackX = inblackX;
	}

	public Integer getInblackY() {
		return inblackY;
	}

	public void setInblackY(Integer inblackY) {
		this.inblackY = inblackY;
	}

	public Integer getInredX() {
		return inredX;
	}

	public void setInredX(Integer inredX) {
		this.inredX = inredX;
	}

	public Integer getInredY() {
		return inredY;
	}

	public void setInredY(Integer inredY) {
		this.inredY = inredY;
	}

...
public class PRule extends Rule {
	...
	private Integer existoneinyY1;

	private Integer existoneinyY2;

	private Integer existoneinxX1;

	private Integer existoneinxX2;
	...
	public Integer getExistoneinyY1() {
		return existoneinyY1;
	}

	public void setExistoneinyY1(Integer existoneinyY1) {
		this.existoneinyY1 = existoneinyY1;
	}

	public Integer getExistoneinyY2() {
		return existoneinyY2;
	}

	public void setExistoneinyY2(Integer existoneinyY2) {
		this.existoneinyY2 = existoneinyY2;
	}

	public Integer getExistoneinxX1() {
		return existoneinxX1;
	}

	public void setExistoneinxX1(Integer existoneinxX1) {
		this.existoneinxX1 = existoneinxX1;
	}

	public Integer getExistoneinxX2() {
		return existoneinxX2;
	}

	public void setExistoneinxX2(Integer existoneinxX2) {
		this.existoneinxX2 = existoneinxX2;
	}

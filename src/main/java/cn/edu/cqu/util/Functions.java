...
public class Functions {
	...
	public static final boolean in(int x, int y) {
		if (x < 0 || x > 8 || y < 0 || y > 9) {
			return false;
		}
		return true;
	...
	public static final boolean inRedHome(int x, int y) {
		if (x <= 5 && x >= 3 && y >= 0 && y <= 2) {
			return true;
		}
		return false;
	...
	// 所下坐标在黑方米字格内，则返回真
	public static final boolean inBlackHome(int x, int y) {
		if (x <= 5 && x >= 3 && y >= 7 && y <= 9) {
			return true;
		}
		return false;
	...
	public static boolean faceToFace(Chessboard board) {
		...
		if (jp1 == null || jp2 == null || jp1.x != jp2.x)
			return false;
		else {
			boolean face = true;
	...
	// 是否在黑方区域，是返回true
	public static final boolean inBlack(int x, int y) {
		if (y >= 5 && y <= 9 && x >= 0 && x <= 8) {
			return true;
		}
	...
	// 是否在红方区域，是返回true
	public static final boolean inRed(int x, int y) {
		if (inBlack(x, y)) {
			return false;
		}
		return true;
